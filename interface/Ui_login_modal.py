...
class Ui_login_modal(object):
    def setupUi(self, login_modal):
        ...
        self.background_frame.setStyleSheet(u"background-color: #F9F6EE;")
        ...
        self.top_bar_frame.setStyleSheet(u"background-color: #93C059;")
        ...
        icon = QIcon()
        icon.addFile(u":/iconos/assets/icons/restore-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/iconos/assets/icons/maximize-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/iconos/assets/icons/minimize-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/iconos/assets/icons/close-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.email.setSizeConstraint(QLayout.SetFixedSize)
...
"")
        ...
        self.password.setSizeConstraint(QLayout.SetFixedSize)
...
"")
        ...
        self.buttons.setSizeConstraint(QLayout.SetMinimumSize)
        ...
        self.send_button.setLayoutDirection(Qt.LeftToRight)

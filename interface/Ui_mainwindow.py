...
"")
        ...
        self.background_frame.setCursor(QCursor(Qt.PointingHandCursor))
...
"")
        ...
        icon = QIcon()
        icon.addFile(u":/iconos/assets/icons/close-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/iconos/assets/icons/minimize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/iconos/assets/icons/maximize-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/iconos/assets/icons/restore-window.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.weghing.setCursor(QCursor(Qt.IBeamCursor))
...
"color: #281F10;")
        ...
        self.tare_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.tare_button.setStyleSheet(u"background: rgba(147, 192, 89, 0.4);\n"
"color: #281F10;\n"
"")
        icon4 = QIcon()
        icon4.addFile(u":/iconos/assets/icons/scale_icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.units_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.units_button.setStyleSheet(u"background: rgba(147, 192, 89, 0.4);\n"
"color: #281F10;")
        icon5 = QIcon()
        icon5.addFile(u":/iconos/assets/icons/weigth_icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.new_record_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.new_record_button.setStyleSheet(u"QPushButton{\n"
"background: rgba(147, 192, 89, 1);\n"
"color: #281F10;\n"
"}\n"
"QPushButton::hover {background-color :  rgba(147, 192, 89, 0.5)};")
        icon6 = QIcon()
        icon6.addFile(u":/iconos/assets/icons/add_icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.session_frame.setGeometry(QRect(20, 60, 761, 51))
        ...
        self.history_button = QPushButton(self.session_frame)
        ...
        self.history_button.setMinimumSize(QSize(130, 30))
        font3 = QFont()
        font3.setFamilies([u"Rubik"])
        font3.setPointSize(16)
        self.history_button.setFont(font3)
...
"QPushButton::hover {background-color :  rgba(147, 192, 89, 0.5)};")
        icon7 = QIcon()
        icon7.addFile(u":/iconos/assets/icons/history_icon.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"QPushButton::hover {background-color :  rgba(147, 192, 89, 0.5)};")
        icon8 = QIcon()
        icon8.addFile(u":/iconos/assets/icons/user_outlined_icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.user_info_frame.setCursor(QCursor(Qt.PointingHandCursor))
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"gr", None))
